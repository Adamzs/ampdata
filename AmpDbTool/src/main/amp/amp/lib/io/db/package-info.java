 ...
 **************************************************************************/
/**
 * Manages all database operations including schema creation and data importing.
 * TODO This should be upgraded to handle multiple database types by completing the Factory pattern for SQLFactory.
 */
